...
**Tools** — PyTorch, TensorFlow, Scikit-Learn, HuggingFace Transformers, vLLM, PySpark, Spark, Pandas, NumPy, Matplotlib, Seaborn, Plotly, Apache Airflow, GitHub Actions, MLflow, MongoDB, Ollama, Kubernetes, Terraform, Git/GitHub, Google Cloud (Vertex AI, Cloud Run, Dataproc, GCS), Docker, Tableau, AWS, Snowflake
